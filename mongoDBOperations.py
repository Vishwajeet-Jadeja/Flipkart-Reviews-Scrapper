...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            # self.url = "mongodb+srv://ineuron:ineuron@cluster1.ypvyb.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
            #     self.username, self.password)
            # self.url = "mongodb+srv://vish2109:vish2109@cluster0.ils2t.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
            #     self.username, self.password)
            self.url = "mongodb+srv://vish2109:vish2109@cluster0.mk2p6.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
                self.username, self.password)
            # self.url = "mongodb+srv://vish2109:vish2109@cluster0.ils2t.mongodb.net/Flipkart-Scrapper?retryWrites=true&w=majority".format(
            #     self.username, self.password)
